...
8. TÜV Rheinland. (2025). *ISO/PAS 8800标准发布，助力汽车人工智能安全技术落地*.

9. Fraunhofer Institute for Experimental Software Engineering. (2025). *AI Safety Assurance in Automotive Systems*.
...
| Calibration | 校准 | $\mathbb{P}(Y=y|p=f(x)=t) = t$ |
