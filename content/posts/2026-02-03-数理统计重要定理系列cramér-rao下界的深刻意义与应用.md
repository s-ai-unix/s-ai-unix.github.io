...
当参数是向量 $\theta = (\theta_1, \ldots, \theta_p)^T$ 时，Fisher信息推广为**Fisher信息矩阵**（Fisher Information Matrix）：
...
例如，对于二维参数，即使 $\mathcal{I}(\theta)_{11}$ 和 $\mathcal{I}(\theta)_{22}$ 固定，非对角元 $\mathcal{I}(\theta)_{12}$ 的变化会影响逆矩阵的对角元，从而改变CRLB。
