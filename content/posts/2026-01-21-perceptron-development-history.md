...
1. 对于 $(0,0)$ → 0：$w_1 \cdot 0 + w_2 \cdot 0 + b < 0$，即 **$b < 0$**
2. 对于 $(0,1)$ → 1：$w_1 \cdot 0 + w_2 \cdot 1 + b \geq 0$，即 **$w_2 + b \geq 0$**
3. 对于 $(1,0)$ → 1：$w_1 \cdot 1 + w_2 \cdot 0 + b \geq 0$，即 **$w_1 + b \geq 0$**
4. 对于 $(1,1)$ → 0：$w_1 \cdot 1 + w_2 \cdot 1 + b < 0$，即 **$w_1 + w_2 + b < 0$**
...
$$
f(x) = \sigma\left(w^{(2)}_1 \cdot \sigma(w^{(1)}_{11} x_1 + w^{(1)}_{12} x_2 + b^{(1)}_1) + w^{(2)}_2 \cdot \sigma(w^{(1)}_{21} x_1 + w^{(1)}_{22} x_2 + b^{(1)}_2) + b^{(2)}\right)
$$
